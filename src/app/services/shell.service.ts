...
export class ShellService {
  ...
  getHelp(): string {
    ...
    help += '&nbsp;&nbsp;touch: Create a file, in memory too<br>';
    help += '&nbsp;&nbsp;cat: Show the context of a file<br>';
    help += '&nbsp;&nbsp;echo: Allow to write content to a file, sintax: echo "Content" >> fileName<br>';
